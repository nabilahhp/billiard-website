      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          if (isset($_SESSION['id_user'])) {
            ...
            echo '<a href="user/bayar.php" class="btn btn-inti"><i class="fas fa-shopping-cart"></i></a>';
                      ...
                      <div class="row justify-content-center align-items-center">
                        ...
                        <div class="col">
                          ...
                          <div class="mb-3">
                            ...
                            <input type="number" name="jam_mulai" class="form-control" id="exampleInputPassword1" disabled>
                          </div>
                        </div>
                        <div class="mb-3">
                          <table id="seatsDiagram">
                            <tr>
                                    <td id="seat-1" data-name="1">12:00</td>
                                    <td id="seat-2" data-name="2">13:00</td>
                                    <td id="seat-3" data-name="3">14:00</td>
                                    <td id="seat-4" data-name="4">15:00</td>
                                    <td id="seat-5" data-name="5">16:00</td>
                                    <td id="seat-6" data-name="6">17:00</td>
                                    <td id="seat-7" data-name="7">18:00</td>
                                    <td id="seat-8" data-name="8">19:00</td>
                                    <td id="seat-9" data-name="9">20:00</td>
                                    <td id="seat-10" data-name="10">21:00</td> 
                                    <td id="seat-11" data-name="10">22:00</td> 
                                    <td id="seat-12" data-name="10">23:00</td> 
                                    <td id="seat-13" data-name="10">00:00</td> 
                                    <td id="seat-14" data-name="10">01:00</td> 
                                    <td id="seat-15" data-name="10">02:00</td> 
                                    <td id="seat-16" data-name="10">03:00</td> 
                                    <td id="seat-17" data-name="10">04:00</td> 
                            </tr>
                          </table>
                        </div>
                      </div>
